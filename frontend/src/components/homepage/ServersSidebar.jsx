...
const ServersSidebar = ({ servers }) => {
  return (
    <div className="hidden md:flex w-20 bg-gradient-to-b from-slate-900 to-gray-900 flex-col items-center py-6 space-y-3 border-r border-gray-700/30 mt-14 shadow-xl">
      ...
      {servers.map((server) => (
        <div key={server.id} className="relative group">
          <div className={`w-14 h-14 ${server.active ? 'bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl shadow-xl shadow-indigo-500/30' : 'bg-gradient-to-br from-gray-700 to-gray-800 rounded-2xl hover:rounded-xl hover:bg-gradient-to-br hover:from-indigo-500 hover:to-purple-600 hover:shadow-xl hover:shadow-indigo-500/30'} flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110 group-hover:rotate-3`}>
            <span className="text-xl drop-shadow-lg">{server.icon}</span>
          </div>
      ...
      {/* Add Server */}
      <div className="relative group">
        <div className="w-14 h-14 bg-gradient-to-br from-gray-700 to-gray-800 rounded-2xl flex items-center justify-center cursor-pointer transition-all duration-300 hover:rounded-xl hover:bg-gradient-to-br hover:from-green-500 hover:to-emerald-600 text-green-400 hover:text-white hover:scale-110 hover:shadow-xl hover:shadow-green-500/30 group-hover:rotate-3">
